...
import { CommentType } from '../CommentBoxList/CommentBoxList';
        ...
        <div className="p-3 py-5">
            <div className="flex justify-between">
                ...
                <div className="text-sm text-gray-400">
                    <button type="button" className="p-2 hover:text-gray-800 ">수정</button>
                    <button type="button" className="hover:text-gray-800 ">삭제</button>
                </div>
            </div>
